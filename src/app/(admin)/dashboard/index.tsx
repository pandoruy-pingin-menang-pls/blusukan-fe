    ...
    <View className="flex-1 bg-surface">
      ...
      <View className="px-4 mt-4">
        ...
        <Pressable 
          ...
          className="rounded-card border border-line shadow-sm overflow-hidden mb-6"
        >
          <LinearGradient
          ...
          >
            <ImageBackground
              source={require("../../../../assets/promo-batik-overlay.png")}
              style={{ width: '100%', flexDirection: 'row', alignItems: 'center', padding: 16 }}
              imageStyle={{ opacity: 0.15 }}
              resizeMode="cover"
            >
              <View className="mr-3">
                <FontAwesome6 name="boxes-stacked" size={20} color="#FFFFFF" />
              </View>
              <View className="flex-1">
                <Text className="text-white font-sans-bold text-sm mb-0.5">Recalculate Inventory</Text>
                <Text className="text-white/80 font-sans text-xs">Hitung ulang saran stok via Celery</Text>
              </View>
              
              {recalculating ? (
                <ActivityIndicator color="#FFFFFF" className="ml-2" />
              ) : (
                <FontAwesome6 name="chevron-right" size={12} color="#FFFFFF" className="ml-2" />
              )}
            </ImageBackground>
          </LinearGradient>
        </Pressable>
              ...
              >
                ...
                <View className="p-4 flex-row items-start">
                  ...
                  <View className={`px-2 py-1 rounded-full border ${
                    event.status === 'approved' ? 'border-[#0369a1] bg-transparent' : 
                    ...
                    <Text className={`font-sans-medium text-[10px] ${
                      event.status === 'approved' ? 'text-[#0369a1]' : 
